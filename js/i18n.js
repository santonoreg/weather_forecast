...
const I18N = {
  en: {
    ...
    'h.source': 'Source: ERA5 / ERA5-Land reanalysis (Open-Meteo Historical Weather API) – modelled from observations, not station measurements. Last updated on {date}.',
    'h.status.new': 'Downloaded now and stored – next time it opens instantly.',
    'h.status.cached': 'Up to date – loaded from the local cache.',
    'h.status.added': 'Updated: {n} new days were downloaded and added.',
    'h.update': 'Check for new data now',
    'h.rec.title': 'Records',
    ...
    'h.climate': 'Average year – temperature by month',
    'h.heat': 'Temperature by month across the whole history',
    'h.heat.anom': 'Difference from average', 'h.heat.abs': 'Actual temperature',
    'h.heat.hint.anom': 'Each column is a year, each row a month. Red = warmer than the long-term average of that month, blue = colder.',
    'h.heat.hint.abs': 'Each column is a year, each row a month. Colour = mean temperature of that month.',
  ...
  el: {
    ...
    'h.source': 'Πηγή: επανανάλυση ERA5 / ERA5-Land (Open-Meteo Historical Weather API) – προκύπτει από μοντέλο με βάση παρατηρήσεις, δεν είναι μετρήσεις σταθμού. Τελευταία ενημέρωση: {date}.',
    'h.status.new': 'Λήφθηκε τώρα και αποθηκεύτηκε – την επόμενη φορά ανοίγει αμέσως.',
    'h.status.cached': 'Ενημερωμένο – φορτώθηκε από την τοπική αποθήκευση.',
    'h.status.added': 'Ενημερώθηκε: κατέβηκαν και προστέθηκαν {n} νέες ημέρες.',
    'h.update': 'Έλεγχος για νέα δεδομένα τώρα',
    'h.rec.title': 'Ρεκόρ',
    ...
    'h.climate': 'Μέσο έτος – θερμοκρασία ανά μήνα',
    'h.heat': 'Θερμοκρασία ανά μήνα σε όλο το ιστορικό',
    'h.heat.anom': 'Απόκλιση από τον μέσο όρο', 'h.heat.abs': 'Πραγματική θερμοκρασία',
    'h.heat.hint.anom': 'Κάθε στήλη είναι ένα έτος και κάθε γραμμή ένας μήνας. Κόκκινο = θερμότερος από τον μακροπρόθεσμο μέσο όρο του μήνα, μπλε = ψυχρότερος.',
    'h.heat.hint.abs': 'Κάθε στήλη είναι ένα έτος και κάθε γραμμή ένας μήνας. Χρώμα = μέση θερμοκρασία του μήνα.',
